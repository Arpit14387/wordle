...
// localStorage.clear("mediummodestats")
  if(localStorage.getItem("mediummodestats"))
  {
   
    let data=JSON.parse(localStorage.getItem("mediummodestats"))
    loss=data.loss;
    wins=data.wins;
    total=data.total;
    streak=data.streak;
  ...
  {
    localStorage.setItem("mediummodestats",
    JSON.stringify({
      "total": 0,
      "wins": 0,
      "loss": 0,
    ...
    JSON.stringify({
      ...
      "streak": streak
        ...
        else if(!(v=="ggggg") && sessionval.length==20){
